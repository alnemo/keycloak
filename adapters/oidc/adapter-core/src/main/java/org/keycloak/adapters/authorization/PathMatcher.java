...
class PathMatcher {
    ...
    private PathCache cache = new PathCache(1000, 300000);
    ...
    public boolean exactMatch(String expectedUri, String targetUri, String value) {
    ...
    public boolean isTemplate(String uri) {
